...
urlpatterns = [
    ...
    path('profile/add_industry/', views.add_industry, name='add_industry'),
    path('skills/<int:pk>/delete/',
         views.SkillDelete.as_view(), name='skill_delete'),
    path('industries/<int:pk>/delete/',
         views.IndustryDelete.as_view(), name='industry_delete'),
    path('jobs/<int:pk>/delete/',
         views.JobDelete.as_view(), name='job_delete'),
